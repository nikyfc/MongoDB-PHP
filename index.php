...
<html lang="es">
  ...
  <body>
	...
	<div class="container">
		<h2>Sistema Biblioteca PHP + MongoDB</h2>
		<p class="text-info">En esta sección podremos listar, agregar, modificar y eliminar libros.</p><br><br>
		<?php
			...
			<div class="control-group">
		    	...
		    	<div class="controls">
		      		<select name="autor" required>
						...
						?>
						<option value="<?php echo $autor['nombre'] ?>">
							<?php echo $autor['nombre'] ?></option>
						<?php 
								}
							}else{
						?>
		  	...
		  	<div class="control-group">
		    	...
		    	<div class="controls">
		      		<textarea name="descripcion" rows="6" class="input-xlarge" required></textarea>
		    	</div>
		  	</div>
		  	<div class="control-group">
		    	<div class="controls">
